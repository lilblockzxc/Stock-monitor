Приложение: Биржевой монитор, предназначено для отображения актуальных котировок акций, позволяющее пользователям отслеживать изменение цен в реальном времени.
